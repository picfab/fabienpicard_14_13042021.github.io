![capture](https://raw.githubusercontent.com/picfab/fabienpicard_14_13042021.github.io/master/docs/capture.png)
...
Watch the test coverage with
``npm run test -- --coverage``

For all test pass you need to comments line 87 to 90
``` javascript
    setOpen(true)
